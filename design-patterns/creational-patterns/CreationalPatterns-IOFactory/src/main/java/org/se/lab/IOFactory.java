	...
	implements IOFactoryOperations
{
	...
	public PrintWriter createPrintWriter(String fileName)
	{
		...
		{
			throw new IllegalStateException("Can't create PrintWriter to file " + fileName, e);
		}
	}
	...
	public BufferedReader createBufferedReader(String fileName)
	{
		...
		{
			throw new IllegalStateException("Can't create BufferedReader to file " + fileName, e);
		}
	}
}
